...
## Project Structure
    ...
    ├── tst_sampletform_dev_87300  # Django project configurations
...
1. Clone this repo and `cd tst_sampletform_dev_87300`
...
2. Clone this repo and `cd tst_sampletform_dev_87300`
